import 'dart:io';
import 'dart:ui';
import 'package:expense_manager_flutter/extensions/extensions.dart';
import 'package:expense_manager_flutter/models/models.dart';
import 'package:expense_manager_flutter/widgets/new_transaction.dart';
          ...
          child: Column(
            children: [
              ...
              DetailsRow(
                  title: 'Amount:',
                  content:
                  '${'Rs.'} ${_transaction.amount.toStringAsFixed(2)}'),
              DetailsRow(
                  title: 'Date:',
                  content:
